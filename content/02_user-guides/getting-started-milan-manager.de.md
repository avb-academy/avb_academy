...
- Offline-Dokumentation: wird mit der Installation geliefert. [Hier öffnen](#offline-dokumentation)  
{{% /notice %}}
...
|--------------|------------|
| Beim ersten Öffnen des Milan Managers den *Devices*-Tab auswählen. **Wichtig:** Dieser Schritt ist nur notwendig, wenn ein Milan-Netzwerk zum ersten Mal konfiguriert wird. | ![Milan Manager devices tab](/images/00-Milan-Manager.png) |
| Einen passenden Media Clock Master für die Media Clock Domain auswählen. | ![Milan Manager Media Clock Domain configuration](/images/01-Milan-Manager.png) |
| Im *Overview*-Tab die Streams vom Talker zum Listener verbinden. | ![Milan Manager Stream configuration](/images/02-Milan-Manager.png) |
| Im *Routing*-Tab den Listener auswählen und das Kanalrouting konfigurieren. | ![Milan Manager Channel patch](/images/03-Milan-Manager.png) |
